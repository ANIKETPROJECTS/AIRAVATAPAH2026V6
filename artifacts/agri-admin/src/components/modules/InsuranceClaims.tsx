...
import { ChevronLeft, ChevronRight, Search, RefreshCw, Shield, ArrowLeft, AlertTriangle, Trash2, Pencil } from "lucide-react";
        ...
        <div className="fixed inset-0 bg-foreground/40 z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-base">Delete Claim</h3>
                <p className="text-xs text-muted-foreground font-mono">{deleteModal.id}</p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground">Are you sure you want to permanently delete the claim for <span className="font-semibold text-foreground">"{deleteModal.name}"</span>? This cannot be undone.</p>
            <div className="flex gap-2 justify-end">
        ...
        <div className="fixed inset-0 bg-foreground/40 z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-base">Edit Claim</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead><tr className="bg-white border-b border-black/8 text-left">
                  ...
                  <th className="px-4 py-3 text-sm font-medium text-black">Date Filed</th>
